...
test('version recognition preserves the exact tested stable or prerelease version', () => {
  for (const version of ['0.153.4', '0.154.0-alpha.6.2', '0.155.0-alpha.2.6', '0.155.0-alpha.9.2']) {
...
test('nearby releases, altered prereleases and malformed version strings cannot bypass the policy', () => {
  for (const version of ['0.154.0', '0.154.0-alpha.6.1', '0.154.0-alpha.6.3', '0.155.0-alpha.2.5', '0.155.0-alpha.2.7', '0.155.0-alpha.2.6.extra', '0.155.0-alpha.2.6/extra', '0.153.4-alpha.1', '0.154.0-alpha.6.2.extra', '0.154.0-alpha.6.2/extra', '0.153.4+unverified']) {
  ...
  for (const version of ['0.155.0-alpha.9.1', '0.155.0-alpha.9.3', '0.155.0-alpha.9.2.extra', '0.156.1']) assert.throws(() => verifyCodexVersion(`modern_codex_editor/${version}`), /No paper text was sent/);
});
