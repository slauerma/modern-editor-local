...
Use **Security → Report a vulnerability**, or open the
[private reporting form](https://github.com/slauerma/modern-editor-local/security/advisories/new).
If you cannot access it, contact the maintainer through your existing private
channel. If you have no private contact route, open an issue asking for one
without describing the vulnerability or attaching sensitive material.
